...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"dp_startup_logo_active_brand", {PERSISTENT, INT, "0"}},
    {"dp_startup_logo_ford_index", {PERSISTENT, INT, "0"}},
    {"dp_startup_logo_lincoln_index", {PERSISTENT, INT, "0"}},
    {"dp_startup_spinner_track_index", {PERSISTENT, INT, "0"}},
    ...
    {"enable_human_turn_detection", {PERSISTENT, BOOL, "1"}},
    ...
    {"BPShowConfidenceBall", {PERSISTENT, BOOL, "1"}},
    {"BPAnimateSteeringWheel", {PERSISTENT, BOOL, "1"}},
    {"ShowBlindspotOverlay", {PERSISTENT, BOOL, "1"}},
    {"ShowBrakeStatus", {PERSISTENT, BOOL, "0"}},
    {"FordPrefShowRadarLeadOverlay", {PERSISTENT, BOOL, "0"}},
    {"FordPrefRadarOverlaySize", {PERSISTENT, INT, "1"}},
    {"disable_BP_long_UI", {PERSISTENT, BOOL, "0"}},
    {"disable_downhill_comp_UI", {PERSISTENT, BOOL, "0"}},
    ...
    {"enable_lane_full_mode", {PERSISTENT, BOOL, "0"}},
    {"custom_profile", {PERSISTENT, INT, "0"}},
    {"LC_PID_gain_UI", {PERSISTENT, FLOAT, "3.0"}},
    {"disable_BP_lat_UI", {PERSISTENT, BOOL, "0"}},
    {"BlinkerPauseLaneChange", {PERSISTENT, BOOL, "0"}},
    {"BlinkerMinLateralControlSpeed", {PERSISTENT, INT, "20"}},
    {"BlinkerLateralReengageDelay", {PERSISTENT, INT, "0"}},
